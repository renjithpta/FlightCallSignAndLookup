...
const network     = require("../fabric/utils.js")
...
exports.flightFromCallSign = async (req, res) => {
    ...
    console.log(`======START =========flightFromCallSign=====================`.yellow.bold)
    ...
    network.query(networkObj, "flightFromCallSign", callSign, scheduleDate, arrivalOrDept)
        .then(result => {
            console.log(`=========Received=======${result}====`.bgGreen.bold);
            if (result) {
                if (result.length > 0) {
...
exports.airportDuartionByIATACode = async (req, res) => {
    ...
    console.log(`======START ====airportDuartionByIATACode=======================`.yellow.bold)
    ...
    network.query(networkObj, "getAirportDuartionByIATACode", req.params.code)
        .then(result => {
            console.log(`=========Received=======${result}====`.bgGreen.bold);
            if (result) {
                if (result.length > 0) {
...
exports.airportDuartionByICAOCode = async (req, res) => {
    ...
    console.log(`======START ====airportDuartionByICAOCode=====================`.yellow.bold);
    let networkObj  = await network.connectToNetwork(req.username.trim());
    if (networkObj.err) {
        res.send(networkObj);
    }
      
    network.query(networkObj, "getAirportDuartionByICAOCode", req.params.code)
        .then(result => {
            console.log(`=========Received=======${result}====`.bgGreen.bold);
            if (result) {
                if (result.length > 0) {
...
exports.durationFromFlight = async (req, res) => {
    console.log(`======start ====durationFromFlight=======================`.yellow.bold)
    ...
    network.query(networkObj, "getDurationFromFlight",  scheduledFlight, scheduledDate, iataAirportCode)
        .then(result => {
            console.log(`=========Received=======${result}====`.bgGreen.bold);
            if (result) {
                if (result.length > 0) {
...
exports.orginScheduleFromFlight = async (req, res) => {
    ...
    console.log(`======start ====orginScheduleFromFlight=======================`.yellow.bold)
    const { scheduledFlight, scheduledDate, iataAirportCode } = req.body;
    ...
    network.query(networkObj, "getOrginScheduleFromFlight", scheduledFlight, scheduledDate, iataAirportCode)
        .then(result => {
            console.log(`=========Received=======${result}====`.bgGreen.bold);
            if (result) {
                if (result.length > 0) {
